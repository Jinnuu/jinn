...
datatype_quiz_dic = {'question': ['Q1. 다음 중 변수의 이름으로 옳지 않은 것은?', 'Q2. 다음 중 자료형에 대한 설명으로 옳지 않은 것은?'], 'answer': [3, 3], 'options': [['123data',
                                                                                                                       '_data', 'data*', 'Data'], ['int: 정수형 자료형은 양의 정수, 음의 정수, 그리고 0을 대입할 수 있다.', 'float: 실수형에는 허수가 아닌 모든 실수가 저장된다.', 'string: 문자열은 공백을 포함할 수 없다.', 'bool: 불 자료형은 참, 거짓을 의미한다.']]}
...
datastructure_quiz_dic = {'question': ['Q1. list 내장함수 중에서 데이터들을 알파벳 \n순서대로 정렬하는 내장함수로 올바른 것은?', "Q2. 다음 데이터타입의 '4월' 위치 앞에 '3월' 데이터를 \n추가하기 위한 명령어로 올바른 것은? \n(조건: month=['1월', '2월', '4월', '5월', '6월', '7월', '8월', '9월', '10월', '11월', '12월']", 'Q3. \n\n다음 중 파이썬 실행의 결과 값으로 틀린 것은?'], 'answer': [1, 4, 2], 'options': [
    ['sort()', 'sorted()', 'place()', 'replace()'], ["month.add(1, '3월')", "month.append(2, '3월')", "month.sort(2, '3월')", "month.insert(2, '3월')"], ['pow(2, 4)는 16이다.', 'list(range(5, 10))은 [5, 6, 7, 8, 9, 10]이다.', 'tuple("abs"는 (\'a\', \'b\', \'c\')이다.', 'type("school")은 < class \'str\'>이다.']]}
...
window=Tk()
window.title("PPePPe : Python Program")
...
btn10_3=Button(quiz_menu_frame, text="Chapter9", width=9, height=1, font=("DungGeunMo", 30 , "bold"), fg="white", bg="#377bc0", command=lambda:quiz(exception_quiz_dic, "Exceptrion Quiz", 0))
...
exit_btn_4=Button(install_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#124e8c", command=lambda:transport(install_frame, main_menu_frame))
...
exit_btn_5=Button(chapter_1_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#124e8c", command=lambda:transport(chapter_1_frame, main_menu_frame))
...
exit_btn_6=Button(chapter_2_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#124e8c", command=lambda:transport(chapter_2_frame, main_menu_frame))
...
exit_btn_7=Button(chapter_3_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#124e8c", command=lambda:transport(chapter_3_frame, main_menu_frame))
...
exit_btn_8=Button(chapter_4_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#124e8c", command=lambda:transport(chapter_4_frame, main_menu_frame))
...
exit_btn_9=Button(chapter_5_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#124e8c", command=lambda:transport(chapter_5_frame, main_menu_frame))
...
exit_btn_10=Button(chapter_6_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#124e8c", command=lambda:transport(chapter_6_frame, main_menu_frame))
...
exit_btn_11=Button(chapter_7_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#124e8c", command=lambda:transport(chapter_7_frame, main_menu_frame))
...
exit_btn_12=Button(chapter_8_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#124e8c", command=lambda:transport(chapter_8_frame, main_menu_frame))
...
exit_btn_13=Button(chapter_9_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#134e8c", command=lambda:transport(chapter_9_frame, main_menu_frame))
...
exit_btn_14=Button(chapter_10_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#144e8c", command=lambda:transport(chapter_10_frame, main_menu_frame))
...
exit_btn_15=Button(chapter_11_frame, text="EXIT", width=7, height=1, font=("DungGeunMo", 26 , "bold"), fg="white", bg="#154e8c", command=lambda:transport(chapter_11_frame, main_menu_frame))
